                  ...
                  <ul className="space-y-2 mb-4">
                    {country.regions.map((region, rIndex) => (
                      <li key={rIndex} className="flex items-center gap-2">
                        <span className="w-1.5 h-1.5 bg-gray-600 rounded-full" aria-hidden="true" />
                        <span className="text-brand-black/70 text-sm">{region}</span>
                      </li>
                    ))}
                  </ul>
            ...
            {exportSteps.map((item, index) => (
              <FadeIn key={index} delay={index * 100}>
                <div className="relative">
                  <div className="text-6xl font-bold text-gray-600/10 absolute -top-4 -left-2">
                    {item.step}
                  </div>
            ...
            {[
              ...
              <FadeIn key={index} delay={index * 50}>
                <div className="flex items-start gap-4 p-4 bg-white border border-gray-100 rounded-lg">
                  ...
                  <span className="text-brand-black/80">{doc}</span>
                </div>
              </FadeIn>
            ))}
          </div>
